...
#### You should test for the following:
	...
	If you divide by zero, what is the effect? Write a test to describe what you'd prefer to happen under this circumstance, and then correct the code to make that test pass.
