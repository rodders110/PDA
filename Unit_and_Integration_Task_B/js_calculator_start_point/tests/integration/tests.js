...
describe('calculator functionality', function() {
  ...
  it('Does the addition button work', function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number2')).click();
  ...
  it('Does the subtraction button work', function(){
    running_total = element(by.css('#running_total'));
  ...
  it('Does the multiplication button work', function(){
    running_total = element(by.css('#running_total'));
  ...
  it('Does the division button work', function(){
    running_total = element(by.css('#running_total'));
  ...
  it('Does it work with multiple operations', function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number9')).click();
    element(by.css('#operator_subtract')).click();
    element(by.css('#number5')).click();
